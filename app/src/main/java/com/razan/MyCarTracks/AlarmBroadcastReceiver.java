...
public class AlarmBroadcastReceiver extends BroadcastReceiver
{
    ...
    public void onReceive(Context context, Intent intent)
    {
        ...
        PowerManager.WakeLock wl = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "MyCarTracks:AlarmWakeLock");
        wl.acquire();

        // Put here YOUR code.
        Toast.makeText(context, "AlarmBroadcastReceiver !!!!!!!!!!", Toast.LENGTH_LONG).show(); // For example
